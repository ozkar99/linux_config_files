...
//customs:
static const char *dmenu_mpc[] = { "dmenu_mpc", "-fn", font, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
...
static Key keys[] = {
	...
	/* My Functions: */
	{ WINKEY,                       XK_p,      spawn,          {.v = dmenu_mpc } },
	{ WINKEY,                       XK_equal,  spawn,          {.v = vol_up } },
	{ WINKEY,                       XK_minus,  spawn,          {.v = vol_down } },
	{ WINKEY,                       XK_m,      spawn,          {.v = mute_toggle } },
	{ WINKEY,                       XK_c,      spawn,          {.v = mpc_toggle } },
	{ WINKEY,                       XK_x,      spawn,          {.v = mpc_prev } },
	{ WINKEY,                       XK_v,      spawn,          {.v = mpc_next } },
